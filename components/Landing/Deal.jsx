...
<circle id="Ellipse_729" data-name="Ellipse 729" cx={3} cy={3} r={3} transform="translate(0 10.111)" fill="#ffa31a" />
      ...
      <div className="flex mt-[33px] sm:flex-row flex-col items-center gap-[30px]">
        <div className="rounded-xl w-full sm:max-w-[180px] object-cover object-center xl:max-w-[221px]">
          <img src="/assets/images/landing/deal1.svg" className='w-full sm:w-auto' alt="" />

        </div>
        <div className="flex w-full sm:w-auto flex-col">
          <p className="text-base md:text-lg md:leading-[25px] max-w-[281px] text-white">Doing Domestic Flights Booking
at 500₹ off</p>
<p className="mt-[10px] text-2xl md:text-[30px] md:leading-5 text-site_yellow font-bold">₹ 500</p>
...
<p className="text-xs md:text-[15px] md:leading-5 text-light_text">Urgent</p>
<svg xmlns="http://www.w3.org/2000/svg" width={17} height={17} viewBox="0 0 17 17">
<g id="Group_351" data-name="Group 351" transform="translate(-599 -5667.998)">
<circle id="Ellipse_15" data-name="Ellipse 15" cx="8.5" cy="8.5" r="8.5" transform="translate(599 5667.998)" fill="#745fea" />
<path id="Path_4187" data-name="Path 4187" d="M484,2001.4s2.071,4,3,4,6-6,6-6" transform="translate(118.5 3674.1)" fill="none" stroke="#fff" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
</g>
</svg>
...
<p className="text-xs md:text-[15px] md:leading-5 text-light_text">Available</p>
<p className="text-xs md:text-[15px] md:leading-5 text-white">Now</p>
...
<p className="text-[11px] md:leading-5 text-[#00E800]">5% OFF</p>
        ...
        <div className="flex mt-[31px] justify-between items-center w-full">
          <div className="flex gap-4 items-center">
            <div className="h-[52px] w-[52px] rounded-full">
              <img src="/assets/images/landing/profile.svg" alt="profile" />
            </div>
            <div>
              <p className="font-medium text-base md:text-lg md:leading-5 text-white">thatveganman</p>
              <div className="flex mt-[5px] gap-2">
              <img src="/assets/images/landing/stars.svg" alt="profile" />
              <p className="text-[11px] md:leading-5 text-light_text">(55 Reviews)</p>
      ...
      <svg xmlns="http://www.w3.org/2000/svg" width="7.081" height="12.162" viewBox="0 0 7.081 12.162">
<path id="Path_4188" data-name="Path 4188" d="M17.833,11.5l-4.667,4.667L8.5,11.5" transform="translate(-10.086 19.248) rotate(-90)" fill="none" stroke="#ffa31a" strokelinecap="round" strokelinejoin="round" strokemiterlimit="{10}" strokewidth="{2}" />
</svg>
