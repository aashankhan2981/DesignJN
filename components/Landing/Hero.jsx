     ...
     <Image src={dots} alt="dots"  />
        ...
        <div className='flex lg:flex-row relative flex-col-reverse items-center gap-4 xl:gap-5 justify-center w-full'>
            ...
            <div className='relative pl-6  lg:pl-14 z-10'>
               ...
               <button className='text-white    font-medium bg-gradient-to-l from-[#FFA31A] to-[#FEB12E] rounded-xl  py-[9px]   text-base sm:text-lg sm:leading-[27px] px-3 md:py-5 '>Browse Categories </button>
