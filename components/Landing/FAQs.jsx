...
const FAQs = () => {
  ...
  return (
    <div className='mt-[150px] lg:px-10 md:px-6 px-4 w-full flex flex-col items-center'>
        ...
        <p className='mt-2 w-full text-center font-bold text-[20px] text-white inline-flex gap-2 items-center max-w-[350px]'>(We’re Tired of Answering <img className='w-[18px] h-[18px]' src="/assets/images/user/emoji.svg" alt="" /> )</p>
