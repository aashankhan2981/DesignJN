...
const Requirement = () => {
  return (
    <div className='mt-10 w-full max-w-[1400px] px-4 md:px-6 md:mt-14 lg:mt-16 xl:mt-20 '>
        <div className='flex  w-full mb-10 md:mb-12 lg:mb-14 items-end justify-between gap-5 md:flex-row flex-col '>
